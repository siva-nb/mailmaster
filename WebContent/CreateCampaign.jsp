				...
				<div class="leftside-navigation">
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu"><a href="javascript:;" class="active">
								<i class="fa fa-tasks"></i> <span>Form Components</span>
						</a>
							<ul class="sub">
						...
						<li class="sub-menu"><a href="javascript:;" class="active">
							...
							<ul class="sub">
								<li class="active"><a href="mail.html">Inbox</a></li>
		...
		<section id="main-content" class="">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> CKEditor </header>
					...
					<div class="col-md-12">
						...
						<div data-collapsed="0" class="panel">
							...
							<div class="panel-heading">
								<div class="panel-title">Input Grid</div>
							</div>
							...
							<div class="panel-body">
								...
								<div class="row">
									...
									<div class="col-md-12 form-group">
										<input type="text" placeholder=".col-md-12"
											class="form-control">
									</div>
									...
									<div class="col-md-1 form-group">
										<input type="text" placeholder=".col-md-1"
											class="form-control">
									</div>
